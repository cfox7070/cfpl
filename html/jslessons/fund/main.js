...
function $p_Lcfx70_fund\uff3fanim_App$__render$1__D__Lcfx70_threejsfacade_THREE$Mesh__Lcfx70_threejsfacade_THREE$WebGLRenderer__Lcfx70_threejsfacade_THREE$Scene__Lcfx70_threejsfacade_THREE$PerspectiveCamera__V($thiz, mtime, cube$1, renderer$1, scene$1, camera$1) {
  var stime = (0.001 * mtime);
  cube$1.rotation.x = stime;
  cube$1.rotation.y = stime;
  renderer$1.render(scene$1, camera$1);
  window.requestAnimationFrame(((arg1$2) => {
    var arg1 = $uD(arg1$2);
    var this$1 = $m_Lcfx70_fund\uff3fanim_App$();
    $p_Lcfx70_fund\uff3fanim_App$__render$1__D__Lcfx70_threejsfacade_THREE$Mesh__Lcfx70_threejsfacade_THREE$WebGLRenderer__Lcfx70_threejsfacade_THREE$Scene__Lcfx70_threejsfacade_THREE$PerspectiveCamera__V(this$1, arg1, cube$1, renderer$1, scene$1, camera$1)
  }))
}
/** @constructor */
function $c_Lcfx70_fund\uff3fanim_App$() {
  this.Lcfx70_fund\uff3fanim_App$__f_$ = null;
  $n_Lcfx70_fund\uff3fanim_App$ = this;
  this.Lcfx70_fund\uff3fanim_App$__f_$ = $m_sjs_js_Dynamic$literal$()
}
$c_Lcfx70_fund\uff3fanim_App$.prototype = new $h_O();
$c_Lcfx70_fund\uff3fanim_App$.prototype.constructor = $c_Lcfx70_fund\uff3fanim_App$;
/** @constructor */
function $h_Lcfx70_fund\uff3fanim_App$() {
  /*<skip>*/
}
$h_Lcfx70_fund\uff3fanim_App$.prototype = $c_Lcfx70_fund\uff3fanim_App$.prototype;
$c_Lcfx70_fund\uff3fanim_App$.prototype.start__T__V = (function(cnvId) {
  var mcanvas = document.querySelector(cnvId);
  var renderer = new $i_three.WebGLRenderer({
    "canvas": mcanvas
  });
  var camera = new $i_three.PerspectiveCamera(75.0, 2.0, 0.1, 5.0);
  camera.position.z = 2.0;
  var scene = new $i_three.Scene();
  var geometry = new $i_three.BoxGeometry(1.0, 1.0, 1.0);
  var material = new $i_three.MeshBasicMaterial({
    "color": 4500104
  });
  var cube = new $i_three.Mesh(geometry, material);
  scene.add(cube);
  window.requestAnimationFrame(((arg1$2) => {
    var arg1 = $uD(arg1$2);
    var this$8 = $m_Lcfx70_fund\uff3fanim_App$();
    $p_Lcfx70_fund\uff3fanim_App$__render$1__D__Lcfx70_threejsfacade_THREE$Mesh__Lcfx70_threejsfacade_THREE$WebGLRenderer__Lcfx70_threejsfacade_THREE$Scene__Lcfx70_threejsfacade_THREE$PerspectiveCamera__V(this$8, arg1, cube, renderer, scene, camera)
  }))
});
$c_Lcfx70_fund\uff3fanim_App$.prototype.$js$exported$meth$start__T__O = (function(cnvId) {
  this.start__T__V(cnvId)
});
$c_Lcfx70_fund\uff3fanim_App$.prototype.start = (function(arg) {
  var prep0 = $as_T(arg);
  return this.$js$exported$meth$start__T__O(prep0)
});
var $d_Lcfx70_fund\uff3fanim_App$ = new $TypeData().initClass({
  Lcfx70_fund\uff3fanim_App$: 0
}, false, "cfx70.fund_anim.App$", {
  Lcfx70_fund\uff3fanim_App$: 1,
  O: 1
});
$c_Lcfx70_fund\uff3fanim_App$.prototype.$classData = $d_Lcfx70_fund\uff3fanim_App$;
var $n_Lcfx70_fund\uff3fanim_App$;
function $m_Lcfx70_fund\uff3fanim_App$() {
  if ((!$n_Lcfx70_fund\uff3fanim_App$)) {
    $n_Lcfx70_fund\uff3fanim_App$ = new $c_Lcfx70_fund\uff3fanim_App$()
  };
  return $n_Lcfx70_fund\uff3fanim_App$
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
let $e_AnimApp = $m_Lcfx70_fund\uff3fanim_App$();
export { $e_AnimApp as AnimApp };
